...
const Progress = () => {
  ...
  const handleCreateAppointment = () => {
    ...
    axios
      .post('https://demo.habidd.com/api/ehr/exam/clinicalcondition/create.php', formData)
      .then((response) => {
            ...
            <CCardBody md={9} style={{ maxHeight: '400px', overflowY: 'auto' }}>
              <CContainer>
                <CRow className="p-2">
                  <CCol>
                    <strong>
                      <CFormLabel htmlFor="exampleFormControlInput1">Patologia</CFormLabel>{' '}
                    </strong>
                    <CFormInput
                      type="text"
                  ...
                  <CCol>
                    <strong>
                      <CFormLabel htmlFor="exampleFormControlInput1">Existe</CFormLabel>{' '}
                    </strong>
                    <CFormSwitch
                      label="No / Si"

...
const Navs = () => {
  ...
  function getAppointments() {
    const options = {
      method: 'GET',
      url: 'https://demo.habidd.com/api/ehr/diagnostics/list.php?patient_id=1',
    }
    axios
      .request(options)
      .then((response) => {
              ...
              <CTable striped hover bordered>
                <CTableHead color="primary">
                  <CTableRow>
                    ...
                    <CTableHeaderCell scope="col">Diagnostico</CTableHeaderCell>
                    <CTableHeaderCell scope="col">Plan de tratamiento</CTableHeaderCell>
                  </CTableRow>
                </CTableHead>
                <CTableBody>
                  {appointments.map((item, index) => (
                    <CTableRow key={index}>
                      ...
                      <CTableDataCell>{item.diagnosis}</CTableDataCell>

...
const Select = () => {
  ...
  function getAppointments() {
    const options = {
      method: 'GET',
      url: 'https://demo.habidd.com/api/ehr/anamnesis/clinicalcondition/list.php?patient_id=1',
    }
    axios
      .request(options)
      .then((response) => {
            ...
            <CCardBody md={9} style={{ maxHeight: '400px', overflowY: 'auto' }}>
              <CTable striped hover bordered className="text-center">
                <CTableHead color="primary">
                  <CTableRow>
                    <CTableHeaderCell scope="col">Nombre de la condicion clinica</CTableHeaderCell>
